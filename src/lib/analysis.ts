...
아래는 AI가 특정 키워드에 대해 답변한 텍스트다. 이 텍스트에 분석 대상 ${subject}이 언급되었는지, 언급되었다면 텍스트에 나열된 ${subject}들 중 몇 번째 순서로 언급되었는지(1부터 시작), 그리고 분석 대상 ${subject}을 제외하고 언급된 다른 ${subject}명 목록을 뽑아라.
